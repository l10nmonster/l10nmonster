...
// import { stores } from '../helpers/src/stores';
global.l10nmonster ??= {};
...
describe ('gcsJobStore tests', () => {
    ...
    const gcsJobStore = new stores.GCSJobStore({ bucketName: 'l10n-translations', jobsFolder: 'jobs' });
    test('getAvailableLangPairs', async () => {
