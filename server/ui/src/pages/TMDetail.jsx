          ...
          <>
            <Flex align="center" gap={2}>
              ...
              >
                ...
                <Checkbox.Control borderWidth="2px" borderColor="blue.400" />
              </Checkbox.Root>
            </Flex>
            <Flex align="center" gap={2}>
              ...
              <Box as="tr">
                <Box as="th" p={3} borderBottom="1px" borderColor="border.default" minW="60px" textAlign="center">
                  ...
                  >
                    ...
                    <Checkbox.Control borderWidth="2px" borderColor="blue.500" />
                  </Checkbox.Root>
                </Box>
                {showTechnicalColumns && (
                  <>
              ...
              {data.map((item, index) => (
                ...
                >
                  <Box as="td" p={3} borderBottom="1px" borderColor="border.subtle" textAlign="center">
                    ...
                    >
                      <Checkbox.HiddenInput />
                      <Checkbox.Control borderWidth="1px" borderColor="gray.400" />
                    </Checkbox.Root>
                  </Box>
                  {showTechnicalColumns && (
                    <>
