...
import { GCSLegacyJsonTmStore, GCSStoreDelegate } from './index.js';
...
suite.skip('gcsJobStore tests', () => {
    ...
    const gcsJobStore = new GCSLegacyJsonTmStore({ bucketName: 'l10n-translations', bucketPrefix: 'jobs' });
    test('getJob', async () => {
...
suite.skip('gcsStoreDelegate tests', () => {
