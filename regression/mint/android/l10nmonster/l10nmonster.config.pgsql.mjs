import { L10nMonsterConfig, ChannelConfig, policies, normalizers, xml, adapters, providers, stores } from '@l10nmonster/core';
...
const dbName = process.env.PGSQL_DB_NAME || 'l10n_regression_android';
...
// Keeps FsLegacyJsonTmStore because test has pre-populated TM data in translationJobs/
