...
const dbName = process.env.PGSQL_DB_NAME || 'l10n_regression_react-icu';
...
class ReactConfig extends L10nMonsterConfig {
    ...
    constructor() {
        ...
        this.dalManager(new PostgresDALManager({ connectionString }));
        ...
        this.snapStore(superStore.createSnapStore({
            id: 'local',
        }));
    }
